...
import Checks.EditCheck;
import data.MassOfData;
import pages.EditAccountPage;
import pages.LoginPage;

public class EditAccountTeste {
    ...
    public void editarConta() throws InterruptedException {
        ...
        navegador.manage().window().maximize();
            ...
            EditAccountPage editAccountPage = new EditAccountPage(navegador);
            ...
            EditCheck trocaFeita = new EditCheck(navegador);
